...
\subsection{Approximation of $\varphi$-functions}\label{sec:krylovmethodunivariate}
...
We now approximate $\varphi_p(A)v$ by $\varphi_p(V_m H_m V_m^*)v$. Beacuse of orthogonality of the columns of $V_m$,
...
Putting all pieces together, the approximation could be written as
\begin{equation}
...
\begin{proof}
We calculate the exponential of this matrix using \eqref{eq:matrixexponentialdefinition}
...
\begin{equation}
    ...
    \end{aligned}.
\end{equation}
Using \eqref{eq:hhatpowered} and \eqref{eq:matrixphifunctionsclosedform}, we conclude
\begin{equation}
    \begin{aligned}
