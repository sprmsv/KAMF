...
\begin{corollary}
    ...
    This can be shown using the definition of $g$ and Lemma \ref{lm:krylovsubspacepowered}:
    \begin{equation*}
        \begin{aligned}
...
\begin{proof}
    ...
    Corrolary \ref{cor:univariateerrorestimationpolynomial}, the triangle inequality, and the orthonormality of the columns of $V_m$ to get
    \begin{equation*}
        \begin{aligned}
