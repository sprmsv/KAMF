...
def get_convergence(
    ...
    for f in funcs:
        ...
        # Get RA-BRASIL1 error
        # pbar_method.desc = f'Methods: RA-BRASIL1'
        # pbar_method.refresh()
        # r = brasil(f=f.scalar, interval=(a, -1), deg=1)
        # rpoles = r.poles()
        # for m in ms_RA:
        #     data['f'].append(str(f))
        #     data['m'].append(m)
        ...
        # Get RA-BRASIL3 error
        # pbar_method.desc = f'Methods: RA-BRASIL3'
        # pbar_method.refresh()
        # r = brasil(f=f.scalar, interval=(a, -1), deg=3)
        # rpoles = r.poles()
        # for m in ms_RA:
        #     data['f'].append(str(f))
        #     data['m'].append(m)
        ...
        # Get RA-BRASIL5 error
        # pbar_method.desc = f'Methods: RA-BRASIL5'
        # pbar_method.refresh()
        # r = brasil(f=f.scalar, interval=(a, -1), deg=5)
        # rpoles = r.poles()
        # for m in ms_RA:
        #     data['f'].append(str(f))
        #     data['m'].append(m)
